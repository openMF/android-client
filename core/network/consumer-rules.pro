...
# Keep all Retrofit service interfaces and their implementations
...
-keep class com.mifos.core.network.** { *; }
-keep interface com.mifos.core.network.services.** { *; }
