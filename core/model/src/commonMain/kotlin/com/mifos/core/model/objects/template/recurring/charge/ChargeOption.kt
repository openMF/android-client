...
data class ChargeOption(
    ...
    @param:IgnoredOnParcel val chargeAppliesTo: ChargeAppliesTo? = null,
    @param:IgnoredOnParcel val chargeCalculationType: ChargeCalculationType? = null,
    @param:IgnoredOnParcel val chargePaymentMode: ChargePaymentMode? = null,
    @param:IgnoredOnParcel val chargeTimeType: ChargeTimeType? = null,
    @param:IgnoredOnParcel val currency: Currency? = null,
