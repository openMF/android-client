...
/**
 * Registration-based cache manager. Feature DI modules call [register] for each Store
 * that should be cleared on logout; foundation infrastructure stays free of feature
 * knowledge.
 *
 ...
 * ```
 */
@OptIn(ExperimentalStoreApi::class, ExperimentalTime::class)
