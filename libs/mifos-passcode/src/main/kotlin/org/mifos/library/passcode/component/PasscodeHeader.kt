        ...
        Box(
            ...
            if (isPasscodeAlreadySet) {
                Text(
                    ...
                    text = stringResource(id = R.string.library_mifos_passcode_enter_your_passcode),
                ...
                if (activeStep == Step.Create) {
                    Text(
                        modifier = Modifier
                            ...
                            .alpha(alpha = alphaHeader1)
                            .scale(scale = scaleHeader1),
                        text = stringResource(id = R.string.library_mifos_passcode_create_passcode),
                        style = TextStyle(fontSize = 20.sp),
                    )
                    ...
                    Text(
                        ...
                        text = stringResource(id = R.string.library_mifos_passcode_confirm_passcode),
                        style = TextStyle(fontSize = 20.sp),
                    )
                }
            }
