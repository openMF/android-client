...
public class CentersListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.tv_center_id.setText(res.getString(R.string.center_id)+centers.get(i).getId());
        viewHolder.tv_center_name.setText(centers.get(i).getName());

        viewHolder.tv_staff_id.setText(res.getString(R.string.staff_id)+centers.get(i).getStaffId());
        viewHolder.tv_staff_name.setText(centers.get(i).getStaffName());

        viewHolder.tv_office_id.setText(res.getString(R.string.office_id)+centers.get(i).getOfficeId());
