...
import com.mifos.mifosxdroid.dialogfragments.SavingsChargeDialogFragment;
...
public class SavingsChargeFragment extends MifosBaseFragment {
    ...
    public SavingsChargeFragment(){

    }


    public static SavingsChargeFragment newInstance(int accountId, List<Charges> chargesList) {
        SavingsChargeFragment fragment = new SavingsChargeFragment();
    ...
    public static SavingsChargeFragment newInstance(int accountId,List<Charges> chargesList, boolean isParentFragmentAGroupFragment) {
        SavingsChargeFragment fragment = new SavingsChargeFragment();
        Bundle args = new Bundle();
        args.putInt(Constants.SAVINGS_ACCOUNT_NUMBER, accountId);
        fragment.setArguments(args);
    ...
    public void inflateChargeList() {
        ...
        final ChargeNameListAdapter chargesNameListAdapter = new ChargeNameListAdapter(context, chargesList,accountId);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == MENU_ITEM_ADD_NEW_CHARGES) {
            SavingsChargeDialogFragment chargeDialogFragment = SavingsChargeDialogFragment.newInstance(accountId);
            FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
            fragmentTransaction.addToBackStack(FragmentConstants.FRAG_CHARGE_LIST);
            chargeDialogFragment.show(fragmentTransaction, "Savings Charge Dialog Fragment");
        }
    ...
    public void fetchChargesList() {
        ...
        if (chargesList.size() > 0) {
            ...
            //Get a Client List
            App.apiManager.getSavingsCharges(accountId, new Callback<Page<Charges>>() {
                @Override
