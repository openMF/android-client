...
fun LoanAccountApprovalScreen(
    ...
    MifosScaffold(
        ...
        title = stringResource(id = R.string.approve_loan),
        ...
        Box(
            ...
            when (uiState) {
                ...
                is LoanAccountApprovalUiState.ShowLoanApproveSuccessfully -> {
                    Toast.makeText(
                        context,
                        stringResource(id = R.string.loan_approved),
                        Toast.LENGTH_LONG
                    ).show()
                    navigateBack.invoke()
                }
...
fun LoanAccountApprovalContent(
    ...
    Column(
        ...
        MifosOutlinedTextField(
            ...
            label = stringResource(id = R.string.approvedamount),
        ...
        MifosOutlinedTextField(
            ...
            label = stringResource(id = R.string.transaction_amount),
            keyboardType = KeyboardType.Number,
            error = null
        )
        ...
        MifosOutlinedTextField(
            ...
            label = stringResource(id = R.string.approval_note),
...
fun isFieldValid(amount: String, context: Context): Boolean {
    return when {
        amount.isEmpty() -> {
            Toast.makeText(
                context,
                context.resources.getString(R.string.loan_approval_amount_can_not_be_empty),
                Toast.LENGTH_SHORT
            ).show()
