...
fun LoanAccountDisbursementScreen(
    ...
    MifosScaffold(
        ...
        title = stringResource(id = R.string.disburse_loan),
...
fun LoanAccountDisbursementContent(
    ...
    Column(
        ...
        MifosDatePickerTextField(
            ...
            label = R.string.approval_disbursement_date,
            openDatePicker = {
        ...
        MifosOutlinedTextField(
            ...
            label = stringResource(id = R.string.loan_amount_disbursed),
            error = null,
        ...
        MifosOutlinedTextField(
            ...
            label = stringResource(id = R.string.disbursement_note),
            error = null,
        )
