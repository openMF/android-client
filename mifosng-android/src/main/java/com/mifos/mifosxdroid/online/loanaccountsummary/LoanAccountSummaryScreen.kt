...
fun LoanAccountSummaryScreen(
    ...
    MifosScaffold(icon = MifosIcons.arrowBack,
        title = stringResource(id = R.string.loanAccountSummary),
...
fun LoanAccountSummaryContent(
    ...
    fun getActualDisbursementDateInStringFormat(): String {
        try {
            ...
            Toast.makeText(
                context,
                context.resources.getString(R.string.loan_rejected_message),
                Toast.LENGTH_SHORT
            ).show()
            return ""
        }
    ...
    Column(
        ...
        LoanSummaryFarApartTextItem(
            title = stringResource(id = R.string.loan_amount_disbursed),
            value = if (inflateLoanSummary) loanWithAssociations.summary.principalDisbursed?.toString()
                ?: "" else ""
        )

        LoanSummaryFarApartTextItem(
            title = stringResource(id = R.string.loan_disbursement_date),
...
fun LoanSummaryDataTable(loanSummary: Summary, inflateLoanSummary: Boolean) {
    ...
    DataTableRow(
        summaryColumnTitle = stringResource(id = R.string.summary),
        loanColumnValue = stringResource(id = R.string.loan),
        amountColumnValue = stringResource(id = R.string.amount_paid),
        balanceColumnValue = stringResource(id = R.string.balance),
        isHeader = true,
        color = BluePrimary.copy(alpha = .3f)
    )

    DataTableRow(
        summaryColumnTitle = stringResource(id = R.string.loan_principal),
    ...
    DataTableRow(
        summaryColumnTitle = stringResource(id = R.string.loan_interest),
    ...
    DataTableRow(
        summaryColumnTitle = stringResource(id = R.string.loan_fees),
    ...
    DataTableRow(
        summaryColumnTitle = stringResource(id = R.string.loan_penalty),
    ...
    DataTableRow(
        summaryColumnTitle = stringResource(id = R.string.total),
...
private fun getButtonText(context: Context, status: Status): String {
    return when {
        status.active == true || status.closedObligationsMet == true -> {
            context.resources.getString(R.string.make_Repayment)
        }
        ...
        status.waitingForDisbursal == true  -> {
            ...
            context.resources.getString(R.string.loan_closed)
        }
    }
}
