...
fun LoanRepaymentScheduleScreen(
    ...
    MifosScaffold(
        title = stringResource(R.string.loan_repayment_schedule),
...
fun HeaderLoanRepaymentSchedule() {
    Box(
        ...
        Row(
            ...
            Text(
                modifier = Modifier.weight(3f),
                text = stringResource(id = R.string.loan_amount_due),
                style = MaterialTheme.typography.bodyLarge,
                color = Color.Black,
                textAlign = TextAlign.Center
            )
    ...
    Box(modifier = modifier) {
        Row(
            ...
            Text(
                ...
                text = stringResource(id = R.string.complete) + " : " + totalPaid,
                style = MaterialTheme.typography.bodyLarge,
            ...
            Text(
                ...
                text = stringResource(id = R.string.pending) + " : " + tvTotalUpcoming,
                style = MaterialTheme.typography.bodyLarge,
                color = MaterialTheme.colorScheme.onBackground,
                textAlign = TextAlign.Center
            )
            ...
            Text(
                modifier = Modifier.weight(3.3f),
                text = stringResource(id = R.string.overdue) + " : " + totalOverdue,
                style = MaterialTheme.typography.bodyLarge,
                color = MaterialTheme.colorScheme.onBackground,
                textAlign = TextAlign.End
            )
