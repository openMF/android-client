...
public class PrivacyPolicyFragment extends MifosBaseFragment implements PrivacyPolicyMvpView {

    @Inject
    PrivacyPolicyPresenter presenter;

    public static PrivacyPolicyFragment newInstance(@Nullable Bundle args) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        webViewPrivacyPolicy.loadUrl(getString(R.string.url_privacy_policy));
