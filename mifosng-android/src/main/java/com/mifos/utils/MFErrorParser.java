...
import com.mifos.objects.mifoserror.MifosError400;
...
public class MFErrorParser {
    ...
    public static MifosError400 parseError400(String serverResponse) {
        return gson.fromJson(serverResponse, MifosError400.class);
    }
