...
public class ChargeOptions implements Parcelable {
    ...
    @SerializedName("incomeOrLiabilityAccount")
    ...
    public IncomeOrLiabilityAccount getIncomeOrLiabilityAccount() {
        return incomeOrLiabilityAccount;
    }

    public void setIncomeOrLiabilityAccount(IncomeOrLiabilityAccount incomeOrLiabilityAccount) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.incomeOrLiabilityAccount, flags);
    }
    ...
    protected ChargeOptions(Parcel in) {
        ...
        this.chargeCalculationType = in.readParcelable(ChargeCalculationType.class.getClassLoader
                ());
        this.chargePaymentMode = in.readParcelable(ChargePaymentMode.class.
                getClassLoader());
        this.incomeOrLiabilityAccount = in.readParcelable(IncomeOrLiabilityAccount.class.
                getClassLoader());
    }
