 ...
 */
public class PreClosureInterestCalculationStrategy implements Parcelable {
    ...
    public PreClosureInterestCalculationStrategy() {
    }

    protected PreClosureInterestCalculationStrategy(Parcel in) {
