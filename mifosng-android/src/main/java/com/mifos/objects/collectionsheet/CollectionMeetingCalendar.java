...
public class CollectionMeetingCalendar implements Parcelable {
    ...
    private List<Integer> recentEligibleMeetingDate = new ArrayList<>();
    private List<Integer> createdDate = new ArrayList<>();
    private List<Integer> lastUpdatedDate = new ArrayList<>();
    ...
    protected CollectionMeetingCalendar(Parcel in) {
        ...
        this.nextTenRecurringDates = new ArrayList<>();
        this.humanReadable = in.readString();
        this.recentEligibleMeetingDate = new ArrayList<>();
